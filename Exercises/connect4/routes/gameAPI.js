...
/*
 Request a new gameContainer.
 Still hardcode to handle only one gameContainer at any time
 */
...
/*
 Get an opponent to start a multiplayer gameContainer
...
/*
 Perform a move on the current gameContainer
 */
router.put("/move", function (req, res, next) {
    var move = req.body;
    //gameId is sent with the request, but not used in this simple "one gameContainer" version
    var game = sillyGlobalGameContainer.game;
